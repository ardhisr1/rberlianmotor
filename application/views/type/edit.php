...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Edit Tipe Kendaraan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="<?= base_url() ?>admin-dashboard">Home</a></li>
            <li class="breadcrumb-item"><a href="<?= base_url() ?>list-type">Manajemen Tipe Kendaraan</a></li>
            <li class="breadcrumb-item active">Edit Tipe Kendaraan</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <form role="form" action="<?= base_url('Type/Edit/'. $type['type_id']) ?>" method="post" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="Type">Tipe Kendaraan</label>
                    <input type="text" class="form-control" name="type" placeholder="Tipe Kendaraan" value="<?= $type['type'] ?>" >
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-primary">Edit Tipe Kendaraan</button>
              </div>
            </form>
          </div>
          <!-- /.card -->
